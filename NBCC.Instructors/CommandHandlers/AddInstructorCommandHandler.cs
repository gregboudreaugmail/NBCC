...
public sealed class AddInstructorCommandHandler : ICommandHandler<AddInstructorCommand, int>
{
    ...
    public AddInstructorCommandHandler(IInstructorRepository instructorRepository) => InstructorRepository = instructorRepository ?? throw new ArgumentNullException(nameof(instructorRepository));
